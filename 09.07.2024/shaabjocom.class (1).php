...
class shaabjocom extends plugin_base {
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1[^<]*>(.*)<\/h1>/Uis',
			'content' => '/(?:<div class="jeg_ad jeg_ad_article[^<]*>|<div class="content-inner ">)(.*)(?:<div class="jeg_post_tags">|<div class="jeg_share_bottom_container">)/Uis',
			'author' => false,
	...
	protected function process_list1_link($link, $referer_link, $logic) {
		...
		$temp_link = ''; // https://shaabjo.com/sitemap_index.xml
		if(preg_match_all('/<loc>(http:\/\/shaabjo.com\/post-sitemap\d+?.xml)<\/loc>/Uis', $link, $matches)){
	...
	protected function process_content($content, $article_data){
		...
		$content = preg_replace('/(صدى الشعب)/Uis', '', $content);
		return $content;
	}
