...
class thegulfheraldcom extends plugin_base
{
	...
	protected $logic = array(
		...
		'article' => array(
			...
			'content' => '/<div class="mkdf-post-text-inner clearfix">(.*)<div class="tdn-google-news">/Uis',
			'author' => false,
	...
	protected function process_list1_link($link, $referer_link, $logic)
	{
		...
		$temp_link = ''; // https://www.traveldailynews.gr/post-sitemap71.xml
		if (preg_match_all('/<loc>(https:\/\/www\.traveldailynews\.gr\/post-sitemap\d+?\.xml)<\/loc>/Uis', $link, $matches)) {
