...
class globalchinadailycomcn__english extends plugin_base {
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1[^<]*>(.*)<\/h1>/Uis',
			'content' => '/(?:<div class="main_art">|<div id="Content">|<\/h1>)(.*)(?:<div id="div_currpage">|<div class="w900">|<div class="selectpage">)/Uis',
			'author' => false,
	...
	protected function process_content($content, $article_data)
	{
		...
		$content = preg_replace('/<span id="bread-nav">(.*)<\/span>/Uis', '', $content);
		return $content;
	}
