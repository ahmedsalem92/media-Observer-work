...
$this->log('$section_name=> '.htmlentities($section_name));
$this->log('$section_link=> '.htmlentities($section_link));
	...
	protected $logic = array(
		...
		'list2' => array(
			...
			1 => array(
				'type' => 'article',
				'regexp' => '/<div class="bussiness-post-thumb">\s*<a href="([^"]*)"/Uis',
				'append_domain' => true,
			)
		),
		'article' => array(
	...
	private $list2_link = 'https://ilkha.com/english/FrontFace/List/GetEndNewsScrollData';
	...
	protected function process_list1_link($link, $referer_link, $logic_type) {
		...
		$fake_link =  $this->list2_link . '?searchString=' . $this->default_postback['searchString'] .'&firstItem=' . $this->default_postback['firstItem'];
