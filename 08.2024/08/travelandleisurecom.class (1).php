...
class travelandleisurecom extends plugin_base
{
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1[^<]*>(.*)<\/h1>/Uis',
			'content' => '/<\/h1>(.*)(?:<div class="loc article-left-rail">|<\/article>|<h2 id="mntl-sc-block_3-0"|<div id="travelandleisure-taglines_1-0"|<div class="loc article-right-rail">|<div id="mntl-sc-block_89-0" class="comp mntl-sc-block travelandleisure-sc-block-featuredlink mntl-block">)/Uis',
			'author' => false,
	...
	private $exclude_articles = array(
		'https://www.travelandleisure.com/style/travel-bags/best-fanny-packs'
	);
	...
	protected function process_content($content, $article_data)
	{
		...
		$content = preg_replace('/<span class="link__wrapper">(.*<)\/span>/Uis', '', $content);
		$content = preg_replace('/<div class="mntl-author-tooltip__bottom">(.*)<\/div>/Uis', '', $content);
		$content = preg_replace('/<div class="mntl-attribution__item-date">(.*)<\/div>/Uis', '', $content);
		$content = preg_replace('/<div class="mntl-comment-counter">(.*)<\/div>/Uis', '', $content);
		return $content;
	}
