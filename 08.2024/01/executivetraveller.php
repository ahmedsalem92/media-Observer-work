...
class ttgmena extends plugin_base
{
	...
	protected $logic = array(
		'list1' => array(
			0 => array(
				'type' => 'list1',
				'regexp' => '/<\/li><li><span><a href="(.*) class="next">/Uis',
				'append_domain' => true
			),
			1 => array(
				'type' => 'article',
				'regexp' => [
					'/<section class="section-holder">(.*)<\/section>/Uis',
					'/<div class="img-holder margin-btm pos-relative">.*<a href="(.*)"/Uis',
				],
				'append_domain' => true
			)
		),
		'article' => array(
			'headline' => '/<h1[^<]*>(.*)<\/h1>/Uis',
			'content' => '/<div class="articles-content">(.*)<div class="more-stories margin-top">/Uis',
			'author' => false,
