...
class birgunnet extends plugin_base {
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1>(.*)<\/h1>/Uis',
			'content' => '/(?:<meta itemprop=description name=description property=og:description content="(.*)">.*<div class=resize>|<div class=resize>)(.*(?:<p><strong>Read more:|<div class=tags>))/Uis',
			'author' => false,
