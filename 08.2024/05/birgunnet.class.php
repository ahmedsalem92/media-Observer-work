...
class birgunnet extends plugin_base {
	...
	protected $sections = array(
		'list1' => array(
			0 => array(
				'type' => 'section',
				'regexp' => array (
					'/<ul class="nav d-block wdot">(.*)<\/ul>/Uis',
					'/(<a.*<\/a>)/Uis'
				)
			)
		),
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1>(.*)<\/h1>/Uis',
			'content' => '/(?:<meta itemprop=description name=description property=og:description content="(.*)">.*<div class=resize>|<div class=resize>)(.*<div class=tags>)/Uis',
			'author' => false,
	...
	private $exclude_articles = array(
		'https://www.birgun.net/haber/kapadokya-da-vadide-kaybolup-mahsur-kalan-5-turist-kurtarildi-549578'
	);
