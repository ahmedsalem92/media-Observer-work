...
class thegulfheraldcom extends plugin_base
{
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1[^<]*>(.*)<\/h1>/Uis',
			'content' => '/<div class="x-the-content entry-content">(.*)<div class="x-comment-markup x-comment-form/Uis',
			'author' => false,
	...
	protected function process_list1_link($link, $referer_link, $logic)
	{
		...
		$temp_link = ''; // https://djsaviation.net/post-sitemap2.xml
		if (preg_match_all('/<loc>(https:\/\/djsaviation\.net\/post-sitemap\d+?\.xml)<\/loc>/Uis', $link, $matches)) {
