...
class snabusinesscom extends plugin_base {
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1[^<]*>(.*)<\/h1>/Uis',
			'content' => '/(?:<div class="Infographic_summary__os6kH">|<p class="Article_summary__.*">)(.*)(?:<div class="eltdf-bnl-holder eltdf-pl-eight-holder|<ul class="SocialShare_social)/Uis',
			'author' => false,
	...
	protected function process_content($content, $article_data)
	{
		...
		$content = preg_replace('/(<div class="ContentHeader_author__D_iGW ">.*<\/span>)/Uis', '', $content);
		if (empty($content)) {
			return 'video';
		} else {
			return $content;
