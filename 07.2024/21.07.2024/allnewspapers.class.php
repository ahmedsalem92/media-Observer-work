...
class swiftnewzcom extends plugin_base
{
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1[^<]*>(.*)<\/h1>/Uis',
			'content' => '/<div class="entry-content entry clearfix">(.*)<div class="stream-item stream-item-below-post-content">/Uis',
	...
	{
		$temp_link = '';  // https://allnewspapers.org/wp-sitemap-posts-post-13.xml
		if (preg_match_all('/<loc>(https:\/\/allnewspapers\.org\/wp-sitemap-posts-post-\d+\.xml)<\/loc>/Uis', $link, $matches)) {
