...
class swiftnewzcom extends plugin_base {
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1[^<]*>(.*)<\/h1>/Uis',
			'content' => '/<div class="entry-content entry clearfix">(.*)(?:<\/div><!-- .entry-content \/-->|<div class="post-bottom-meta post-bottom-tags post-tags-modern">|<div class="auto-inserted-ad">)/Uis',
