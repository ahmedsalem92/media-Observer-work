...
class albouslaps extends plugin_base {
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1 class="post-title" itemprop="name">(.*)<\/h1>/Uis',
			'content' => '/<section class="article-content">.*?<div.*?>(.*?)<div id="end-content">/s',
			'author' => false,
	...
	protected function process_list1_link($link, $referer_link, $logic) {
		...
		$temp_link =''; // https://www.albousla.ps/sitemap_1.xml //https://www.albousla.ps/sitemap.xml
