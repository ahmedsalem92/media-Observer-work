...
class aksamcomtr extends plugin_base {
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1[^<]*>(.*)<\/h1>/Uis',
			'content' => '/(?:<div class="news-detail p-3">|<div id="text">|<div class="news-text[^<]*>)(.*)(?:<div class="tags d-flex align-items-center">|<div class="flx fbw mbm">|<div id="ENGAGEYA_WIDGET[^<]*>|<div class="other-news">|<ul class="tags[^<]*>|<\/article)/Uis',
			'author' => false,
