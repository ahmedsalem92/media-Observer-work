...
class aircraftinteriorsinternationalcom extends plugin_base
{
	...
	protected function pre_get_page(&$link) {              //  stealth_proxy
		...
		if (in_array($link, $this->article_links_only)) {
			$link = 'https://www.aircraftinteriorsinternational.com/features/rights-on-flights-the-next-big-step-in-safe-air-travel-for-disabled-passengers.html' . $link . '&stealth_proxy=True';
		}
		else {
			$link = 'https://www.aircraftinteriorsinternational.com/features/rights-on-flights-the-next-big-step-in-safe-air-travel-for-disabled-passengers.html' . $link  . '&stealth_proxy=True';
		}
