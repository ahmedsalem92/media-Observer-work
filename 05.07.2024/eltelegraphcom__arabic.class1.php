...
class eltelegraphcom__arabic extends plugin_base {
	...
	protected $logic = array(
		...
		'article' => array(
			'headline' => '/<h1 class="jeg_post_title">(.*)<\/h1>/Uis',
			'content' => '/<div class="content-inner[^>]*>(.*)(?:<div class="jeg_share_bottom_container|<div class="jnews_author_box)/Uis',
			'author' => '/<div class="bdaia-post-author-name">[^<]*<a[^>]*>(.*)<\/a>/Uis',
